...
img = ImageTk.PhotoImage(Image.open(r"image_724407.jpeg"))
...
SetBtn=Button(Alarm_Tool, text='Save',fg='white',bg='red',font=('Arial',15,'bold'),width=5,height=1,command=Al_Tool)
SetBtn.place(x=30,y=315)

SetBtn1=Button(Alarm_Tool, text='Stop',fg='white',bg='red',font=('Arial',15,'bold'),width=5,height=1,command=Stop_alarm)
SetBtn1.place(x=141,y=315)
CnclBtn=Button(Alarm_Tool, text='Cancel Alarm',fg='white',bg='red',font=('Arial',15,'bold'),height=1,command=Cancel_alarm)
CnclBtn.place(x=250,y=315)
